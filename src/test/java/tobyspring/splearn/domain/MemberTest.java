...
class MemberTest {
	...
	void invalidEmail() {
		assertThatThrownBy(
			() -> Member.create(new MemberCreateRequest("invalid email", "jaeryang", "secret"), passwordEncoder)
		).isInstanceOf(IllegalArgumentException.class);

		Member.create(new MemberCreateRequest("cjl2076@naver.com", "jaeryang", "secret"), passwordEncoder);
	}
}
